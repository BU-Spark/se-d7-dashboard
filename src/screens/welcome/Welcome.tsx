      ...
      <>
        <div className="welcome_bg">
          ...
          <div className="bottom_section">
            ...
            <Button onClick={navigateToNext} className="px-5 py-1 mb-4 welcome_button"variant="primary">
              I am a resident of D7
            </Button>
            <Button onClick={navigateToSignUp} className="px-5 py-1 welcome_button" variant="secondary">
              Find out
            </Button>
          </div>  
        </div>
